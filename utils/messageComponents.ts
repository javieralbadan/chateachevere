...
// ******** APPOINTMENT EDITION ********
/*
TEMPLATE: reschedule_appointment_staff
🔃 Cita reagendada
Cliente: {{client}}
Fecha: {{date}}
...
/*
TEMPLATE: reschedule_appointment_customer
🔃 Cita reagendada
...
/*
TEMPLATE: cancel_appointment_customer
⛔ Cita cancelada

Tu cita programada para {{date}} ha sido cancelada exitosamente.
*/
